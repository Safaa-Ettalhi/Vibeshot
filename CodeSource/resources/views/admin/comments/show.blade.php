...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-white">Comment Details</h1>
</div>
            ...
            <div class="p-4 sm:p-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="flex flex-col sm:flex-row sm:items-center gap-1">
                                    ...
                                    <span class="text-gray-400 text-xs">{{ $comment->post->created_at->format('m/d/Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-4 flex justify-end">
                    <a href="{{ route('admin.posts.show', $comment->post) }}" class="inline-flex items-center px-4 py-2 bg-[#222222] hover:bg-[#333333] text-white text-sm font-medium rounded-lg transition-colors">
                        <i data-feather="external-link" class="w-4 h-4 mr-2"></i> View Full Post
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#111111]/90 rounded-xl border border-gray-800/50 shadow-lg backdrop-blur-sm overflow-hidden mb-6">
            ...
            <div class="p-4 sm:p-6">
                <div class="space-y-5">
                    ...
                    <div>
                        <div class="text-sm font-medium text-gray-400 mb-2">Post</div>
                        <div class="bg-[#191919] px-4 py-3 rounded-lg">
                            <a href="{{ route('admin.posts.show', $comment->post) }}" class="flex items-center gap-2 hover:text-blue-400 transition-colors text-white">
                                ...
                                @endif
                                <span class="truncate">{{ Str::limit($comment->post->caption, 20) ?: 'No caption' }}</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="text-sm font-medium text-gray-400 mb-2">Last Modified</div>
                        <div class="bg-[#191919] px-4 py-3 rounded-lg text-white flex items-center">
...
<div class="flex flex-col sm:flex-row sm:justify-between gap-4 mt-8">
    ...
    <div>
        <form action="{{ route('admin.comments.destroy', $comment) }}" method="POST" 
              onsubmit="return confirm('Are you sure you want to delete this comment? This action cannot be undone.');" class="w-full sm:w-auto">
            @csrf
            @method('DELETE')
